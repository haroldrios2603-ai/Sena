...
export class ParkingService {
     ...
     */
    async setTariff(parkingId: string, vehicleType: string, baseRate: number, hourlyRate: number) {
    ...
    async registerExit(plate: string) {
        ...
        if (!ticket) throw new NotFoundException('No se encontró un ticket activo para esta placa');
        ...
        // Buscar tarifa
        const tariff = ticket.parking.tariffs.find((t: any) => t.vehicleType === ticket.vehicle.type);
