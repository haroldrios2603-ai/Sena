...
- [x] Endpoint `POST /parking/exit` calcula duración y monto.
- [x] Lógica de tarificación aplicada (Carro vs Moto).
- [x] Frontend muestra resumen de cobro y confirma salida.
